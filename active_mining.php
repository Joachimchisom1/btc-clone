...
<section class="inner-hero bg_img" data-background="assets/images/bg/bg-1.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="page-title">Active Mining</h2>
                <ul class="page-breadcrumb">
                    <li>
                        <a href="index.html">Dashboard</a>
                    </li>
                    <li>Active Mining / Log</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 ">
        <div style="text-align: center;" class="table-responsive--md p-0 ">
            ...
            <table class="table style--two white-space-nowrap ">
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM tbl_investement WHERE (user_id	 = '$usename' AND inv_type = 'Mining') ORDER BY id DESC";
                    ...
                    ?>
                        <tr>
                            ...
                            <td data-label="TIME REMAINING">
                                ...
                                ///ANTMINER plan_____________________________________________________________
                                if ($row['status'] == 'Active') {
                                    if ($row['plan'] == 'ANTMINER') {
                                        ...
                                        if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $row['num_of_days_run_so_far'] == 0) {
                                            ...
                                            ANTMINER($connection, $amount_invested, $id, $user_id);
                                        } else {
                                            //echo "run with check";
                                            ...
                                            if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $num_of_days_run_so_far != 0) {
                                                ...
                                                ANTMINER1($connection, $amount_invested, $id, $num_of_days_run_so_far);
                                            }
                                        }
                                    }
                                }

                                ///DRAGONMINTER plan_____________________________________________________________
                                if ($row['status'] == 'Active') {
                                    if ($row['plan'] == 'DRAGONMINTER') {
                                        $amount_invested = $row['amount_invested'];
                                        $id = $row['id'];
                                        $user_id = $row['user_id'];
                                        $num_of_days_run_so_far = $row['num_of_days_run_so_far'];
                                        if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $row['num_of_days_run_so_far'] == 0) {
                                            ...
                                            DRAGONMINTER($connection, $amount_invested, $id, $user_id);
                                        } else {
                                            //echo "run with check";
                                            // basic1($row['amount_invested'], $row['id'],  $connection);
                                            // echo "run with check <br>";
                                            ...
                                            if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $num_of_days_run_so_far != 0) {
                                                ...
                                                DRAGONMINTER1($connection, $amount_invested, $id, $num_of_days_run_so_far);
                                            }
                                        }
                                    }
                                }

                                ///PAGOLINMINER plan_____________________________________________________________
                                if ($row['status'] == 'Active') {
                                    if ($row['plan'] == 'PAGOLINMINER') {
                                        $amount_invested = $row['amount_invested'];
                                        $id = $row['id'];
                                        $user_id = $row['user_id'];
                                        $num_of_days_run_so_far = $row['num_of_days_run_so_far'];
                                        if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $row['num_of_days_run_so_far'] == 0) {
                                            ...
                                            PAGOLINMINER($connection, $amount_invested, $id, $user_id);
                                        } else {
                                            //echo "run with check";
                                            // basic1($row['amount_invested'], $row['id'],  $connection);
                                            // echo "run with check <br>";
                                            ...
                                            if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $num_of_days_run_so_far != 0) {
                                                ...
                                                PAGOLINMINER1($connection, $amount_invested, $id, $num_of_days_run_so_far);
                                            }
                                        }
                                    }
                                }

                                ///AVALONMINER plan_____________________________________________________________
                                if ($row['status'] == 'Active') {
                                    if ($row['plan'] == 'AVALONMINER') {
                                        $amount_invested = $row['amount_invested'];
                                        $id = $row['id'];
                                        $user_id = $row['user_id'];
                                        $num_of_days_run_so_far = $row['num_of_days_run_so_far'];
                                        if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $row['num_of_days_run_so_far'] == 0) {
                                            ...
                                            AVALONMINER($connection, $amount_invested, $id, $user_id);
                                        } else {
                                            //echo "run with check";
                                            // basic1($row['amount_invested'], $row['id'],  $connection);
                                            // echo "run with check <br>";
                                            ...
                                            if (date('Y-m-d H:i:s') > $row['invt_end_date'] && $num_of_days_run_so_far != 0) {
                                                ...
                                                AVALONMINER1($connection, $amount_invested, $id, $num_of_days_run_so_far);
                                            }
                                        }
                                    }
                                }
...
////ANTMINER FUC----------------------
function ANTMINER($connection, $amount_invested, $id, $user_id)
{
   ...
   $query .= "VALUES('{$date}','{$trascid}','{$amount_with_percentage}','interest_w','Profit from Mining','{$deposit_w}', 'pluse','{$user_id}')";
...
////DRAGONMINTER FUC----------------------
function DRAGONMINTER($connection, $amount_invested, $id, $user_id)
{
...
////PAGOLINMINER FUC----------------------
function PAGOLINMINER($connection, $amount_invested, $id, $user_id)
{
...
////AVALONMINER FUC----------------------
function AVALONMINER($connection, $amount_invested, $id, $user_id)
{
    // $query = "UPDATE tbl_investement SET num_of_days_run_so_far = 3";
    // $query .= " WHERE id = '$id' ";
    // $update_investor_table =  mysqli_query($connection, $query);
