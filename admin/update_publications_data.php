...
if (isset($_POST['id'])) { 
	...
	$sqlQuery = "SELECT * FROM publications WHERE id = $id";  
    $result = mysqli_query($connection, $sqlQuery); 

$paginationHtml = '';
while ($row = mysqli_fetch_assoc($result)) { 
	$paginationHtml.='<form class="reset" id="publication_Form"  enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input accept="image/*" id="imgup" type="file" name="images">
	</div>
