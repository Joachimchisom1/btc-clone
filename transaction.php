...
<section class="inner-hero bg_img" data-background="assets/images/bg/bg-1.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="page-title">All Transaction Log</h2>
    ...
    <div class="col-lg-12 ">
        ...
        <h3>Transaction Log</h3>
            <table class="table style--two white-space-nowrap ">
                ...
                <tbody>
                <?php
                    $query = "SELECT * FROM transactions WHERE (username = '$usename') ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td data-label="Amount ">
                            ...
                            "><?php if ($row['type'] == "pluse") {
                                ...
                                echo "-";
                            } ?> $<?php echo number_format($row['amount']); ?></span>
                        </td>
