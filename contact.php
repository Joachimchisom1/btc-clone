    ...
    <section class="pt-120 pb-120">
      <div class="container">
        <div class="contact-wrapper">
          <div class="row">
            <div class="col-lg-6 contact-thumb bg_img" style="width: 20px;" data-background="img/about_laptop.jpg"></div>
            ...
            <div class="row mb-none-30">
              ...
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p><a href="mailto:support@GOLDENPROFIT.ORG"><span class="">support@Goldenprofit.org</span></a></p>
              ...
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p>Address: Str. NICOLAE CARAMFIL, Nr. 49, Etaj 4 Bucureşti Sectorul 1 Romania.</p>
                  </div>
                </div><!-- contact-item end -->
              </div>
            </div>
